...
export default function Features() {
  ...
  return (
    <section id="features" className="relative bg-gray-950">
            ...
            {features.map((feature, index) => (
              <div key={index} className="relative" data-aos="fade-up" data-aos-delay={index * 100}>
                <div className="flex flex-col items-start">
                  <div className="flex items-center justify-center w-16 h-16 rounded-full bg-purple-600 text-white mb-4">
                    {feature.icon}
                  </div>
                  <h3 className="text-xl font-semibold text-gray-200 mb-2">{t(`items.${index}.title`)}</h3>
                  <p className="text-gray-400">{t(`items.${index}.description`)}</p>
                </div>
              </div>
            ))}
          </div>
