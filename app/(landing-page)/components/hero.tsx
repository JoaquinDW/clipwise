    ...
    >
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(255,59,92,0.11) 0%, transparent 68%)",
          filter: "blur(32px)",
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(255,140,0,0.09) 0%, transparent 68%)",
          filter: "blur(32px)",
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background:
            "repeating-linear-gradient(45deg,#181818 0,#181818 8px,#111 8px,#111 16px)",
          aspectRatio: "16/9",
          position: "relative",
          display: "flex",
          alignItems: "center",
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to bottom, transparent 55%, rgba(8,8,8,0.75))",
          }}
        />
        <div
          style={{
        ...
        <div className="fu d3" style={{ position: "relative" }}>
          <div
            style={{
              ...
              height: 400,
              background:
                "radial-gradient(circle, rgba(255,59,92,0.08), transparent 70%)",
              pointerEvents: "none",
            }}
          />
