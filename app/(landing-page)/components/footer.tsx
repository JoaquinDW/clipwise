          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 10 }}>
              {t.productLinks.map(([label, href]) => (
                <li key={label}>
                  <a href={href} className="footer-link" style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 14 }}>
                    {label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 10 }}>
              {t.accountLinks.map(([label, href]) => (
                <li key={label}>
                  <Link href={href} className="footer-link" style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 14 }}>
                    {label}
                  </Link>
                </li>
              ))}
